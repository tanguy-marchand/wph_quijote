...
from wph_syntheses.sufficient_stat import compute_idx_of_sufficient_stat
...
class PhaseHarmonics2d(object):
    ...
    def filters_tensor(self):
        ...
        bump_steerable_filter_filename = os.path.join('bump_steerable_wavelet', 'filters', 'bump_steerable_wavelet_N_'+str(self.N)+'_J_'+str(self.J)+'_L'+str(self.L)+'_dn'+str(self.dn)+'.npy')
        ...
        scaling_function_filename = os.path.join('bump_steerable_wavelet', 'filters', 'bump_scaling_functions_N_{N}_J_{J}.npy'.format(N=self.N, J=self.J))
